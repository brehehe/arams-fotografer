    ...
    public function run(): void
    {
        ...
        $sources = [
            [
                ...
                'status' => 'active',
                'is_primary' => true,
                'created_at' => Carbon::parse('2026-05-29 12:00:00'),
            ],
            [
                'name' => 'Website',
                'type' => 'social_media',
                ...
                'status' => 'active',
                'is_primary' => true,
                'created_at' => Carbon::parse('2026-05-29 11:00:00'),
            ],
            [
                'name' => 'Sosial Media Lainnya',
                'type' => 'social_media',
                'phone' => null,
                'email' => null,
                'description' => 'Platform sosial media lainnya (TikTok, YouTube, Facebook, Threads, dsb)',
                'status' => 'active',
                'is_primary' => true,
                'created_at' => Carbon::parse('2026-05-29 10:00:00'),
            ],
            [
                'name' => 'WO',
                ...
                'phone' => null,
                'email' => null,
                'description' => 'Rekomendasi dari Wedding Organizer (WO) rekanan',
                'status' => 'active',
                'is_primary' => true,
                'created_at' => Carbon::parse('2026-05-29 09:00:00'),
            ],
            [
                'name' => 'Teman',
                'type' => 'individual',
                'phone' => null,
                'email' => null,
                'description' => 'Rekomendasi dari teman / sahabat / rekan',
                'status' => 'active',
                'is_primary' => true,
                'created_at' => Carbon::parse('2026-05-29 08:00:00'),
            ],
            [
                'name' => 'Saudara',
                'type' => 'individual',
                'phone' => null,
                'email' => null,
                'description' => 'Rekomendasi dari keluarga / kerabat / saudara',
                'status' => 'active',
                'is_primary' => true,
                'created_at' => Carbon::parse('2026-05-29 07:00:00'),
            ],
            [
                'name' => 'Lainnya',
                'type' => 'other',
                'phone' => null,
                'email' => null,
                'description' => 'Sumber lainnya / direct order / walk-in',
                'status' => 'active',
                'is_primary' => true,
                'created_at' => Carbon::parse('2026-05-29 06:00:00'),
            ],
        ];
