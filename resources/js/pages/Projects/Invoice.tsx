            ...
            <div className="grid grid-cols-12 gap-6 items-start">
                ...
                <div className="col-span-12 lg:col-span-8 space-y-6">
                    ...
                    <div className="bg-slate-100/70 p-4 sm:p-8 rounded-3xl border border-slate-200/60 shadow-inner flex justify-center">
                        ...
                        >
                            {/* ══════════════════════════════════════════════════════════════════ */}
                            {/* DESAIN UTAMA: GAMBAR 3 (CLASSIC WAVE SIGNATURE & BOTANICAL LUXURY) */}
                            {/* DUA VERSI: 1. PEMBAYARAN (DP/TAGIHAN) & 2. FULL INFORMASI LAYANAN  */}
                            {/* ══════════════════════════════════════════════════════════════════ */}
                                ...
                                <div className="p-6 sm:p-8 space-y-4 relative z-10">
                                    ...
                                    {invoiceVersion === 'payment' ? (
                                        ...
                                        <div className="space-y-4">
                                                    ...
                                                    <table className="w-full text-left text-xs">
                                                        ...
                                                        <tbody className="bg-white">
                                                            <tr>
                                                                ...
                                                                <td className="p-3.5 text-center font-mono font-semibold text-slate-700 align-middle">
                                                                    1 Paket
                                                                </td>
                                                                <td className="p-3.5 text-right font-bold text-slate-900 font-mono text-xs align-middle">
                                            ...
                                            <div className="space-y-1.5">
                                                ...
                                                <div className="rounded-2xl overflow-hidden border border-[#E0D7FE] shadow-2xs">
                                                    <table className="w-full text-left text-xs">
                                                        <thead className="bg-[#0B0E38] text-white">
                                                            <tr className="text-[10px] uppercase font-bold tracking-wider">
                                                                <th className="py-2.5 px-4 text-left">DESKRIPSI LAYANAN</th>
                                                                <th className="py-2.5 px-3 text-center w-16">QTY</th>
                                                            ...
                                                            {addonsList.length > 0 ? (
                                                                addonsList.map((item) => (
                                                                    <tr key={item.id} className="hover:bg-purple-50/30 transition-colors">
                                                                        ...
                                                                        <td className="py-2.5 px-3 text-center font-mono text-slate-600 align-middle">
                                                                            {item.qty}
                                                                        </td>
                                                                        <td className="py-2.5 px-4 text-right text-slate-600 font-mono align-middle">
                                                                            {formatRupiah(item.unit_price)}
                                                                        </td>
                                                                        <td className="py-2.5 px-4 text-right font-bold text-slate-900 font-mono align-middle">
                                                        ...
                                                        {addonsList.length > 0 && (
                                                            <tfoot className="bg-[#F8F7FF] border-t border-[#E0D7FE]">
                                                                <tr>
                                                                    <td colSpan={3} className="py-2 px-4 font-bold text-slate-700 text-right text-[11px]">
                                                                        Subtotal Add-ons:
                                                                    </td>
                                                                    <td className="py-2 px-4 font-bold text-[#5B21B6] font-mono text-right text-xs">
                                            ...
                                            <div className="space-y-1.5">
                                                ...
                                                <div className="rounded-2xl overflow-hidden border border-[#E0D7FE] shadow-2xs">
                                                    <table className="w-full text-left text-xs">
                                                        <thead className="bg-[#0B0E38] text-white">
                                                            <tr className="text-[10px] uppercase font-bold tracking-wider">
                                                                <th className="py-2.5 px-4 text-left">DESKRIPSI BIAYA</th>
                                                                <th className="py-2.5 px-3 text-center w-16">QTY</th>
                                                                <th className="py-2.5 px-4 text-right">HARGA SATUAN</th>
                                                                <th className="py-2.5 px-4 text-right">TOTAL (Rp)</th>
                                                            </tr>
                                            ...
                                            <div className="p-4 px-5 bg-[#F5F3FF] rounded-2xl border border-[#E0D7FE] space-y-2">
                                                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 text-xs pb-3 border-b border-[#E0D7FE]/80">
                                                    <div>
                                    ...
                                    <div className="p-3 bg-white border border-[#E0D7FE] rounded-2xl shadow-2xs grid grid-cols-4 gap-3 items-center divide-x divide-slate-100">
                                        ...
                                        <div className="flex items-center justify-center gap-2 py-1 pl-2">
                                            ...
                                            <div className="text-left">
                                                <p className="text-[10px] font-bold text-slate-800 leading-tight">{customTexts.badge4Title}</p>
                                                <p className="text-[9px] text-slate-500">{customTexts.badge4Sub}</p>
                                            </div>
                                        </div>
                                    </div>
