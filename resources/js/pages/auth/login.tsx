...
export default function Login({ status, canResetPassword = true }: LoginProps) {
    ...
    return (
        <div className="min-h-screen w-full bg-[#EFECE8] flex items-center justify-center p-4 sm:p-6 lg:p-8 font-sans antialiased text-slate-800 selection:bg-rose-900 selection:text-white">
            <Head title="Login - Arams Pictures Client Portal" />
            ...
            <div className="w-full max-w-[1080px] bg-white rounded-[32px] shadow-2xl overflow-hidden flex flex-col lg:flex-row border border-slate-200/80 min-h-[660px]">
                ...
                <div className="w-full lg:w-[500px] xl:w-[520px] bg-[#2E0F15] p-8 sm:p-10 flex flex-col justify-between text-white shrink-0 relative overflow-hidden">
                    ...
                    <div className="absolute inset-0 z-0">
                        ...
                        />
                        <div className="absolute inset-0 bg-gradient-to-t from-[#200A0E] via-[#2E0F15]/80 to-[#2E0F15]/90" />
                    </div>
                    ...
                    <div className="relative z-10 space-y-6">
                        ...
                        <div className="space-y-2 pt-4">
                            ...
                            <div className="w-12 h-0.5 bg-rose-400/50 mt-2 mb-2" />
                            <p className="text-xs text-rose-100/80 leading-relaxed max-w-sm">
                                Terima kasih telah mempercayakan momen spesial Anda kepada Arams Pictures.
                            </p>
                        </div>
                    </div>
                ...
                <div className="flex-1 p-8 sm:p-12 lg:p-14 flex flex-col justify-between bg-white">
                    <div className="max-w-md mx-auto w-full space-y-6">
                        ...
                        <div className="space-y-1.5">
                            <h2 className="text-2xl sm:text-3xl font-serif font-black text-[#380E13] tracking-tight">
                                Welcome Back!
                            </h2>
                            <p className="text-xs text-slate-500 leading-relaxed">
                                Masuk untuk mengakses project dan momen spesial Anda bersama Arams Pictures.
                            </p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div className="space-y-1.5">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-10 pr-4 py-2.5 bg-slate-50 border border-slate-200 focus:bg-white focus:border-[#4A151B] focus:ring-2 focus:ring-[#4A151B]/10 rounded-xl text-xs font-semibold text-slate-900 outline-hidden transition-all"
                                    />
                                </div>
                                {errors.email && (
                            ...
                            <div className="space-y-1.5">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-10 pr-10 py-2.5 bg-slate-50 border border-slate-200 focus:bg-white focus:border-[#4A151B] focus:ring-2 focus:ring-[#4A151B]/10 rounded-xl text-xs font-semibold text-slate-900 outline-hidden transition-all"
                                    />
                                    <button
                                        type="button"
                            ...
                            <div className="flex justify-end pt-0.5">
                                {canResetPassword && (
                                    <Link
                                        ...
                                        className="text-[11px] font-bold text-[#4A151B] hover:underline"
                                    >
                                        Lupa password?
                                    </Link>
                                )}
                            ...
                            <button
                                type="submit"
                                disabled={processing}
                                className="w-full py-3 rounded-xl bg-[#4A151B] hover:bg-[#380E13] text-white font-bold text-xs tracking-wider transition-all shadow-md shadow-[#4A151B]/20 cursor-pointer disabled:opacity-50 flex items-center justify-center gap-2"
                            >
                                {processing ? (
                                    <>
                        ...
                        <div className="bg-[#FAF7F5] border border-amber-900/10 rounded-2xl p-4 flex items-start gap-3.5 mt-6">
                            <div className="w-8 h-8 rounded-xl bg-rose-100 text-rose-800 flex items-center justify-center shrink-0 mt-0.5">
                                <Gift className="w-4 h-4" />
                            </div>
                            <div className="text-xs">
                                <h4 className="font-bold text-slate-900">Belum memiliki akun?</h4>
                                <p className="text-[11px] text-slate-500 mt-0.5 leading-snug">
                                    Hubungi admin Arams Pictures untuk mendapatkan akses ke portal ini.
                                </p>
                            </div>
                        </div>
