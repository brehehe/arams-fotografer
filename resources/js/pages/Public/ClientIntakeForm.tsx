...
export default function ClientIntakeForm({
    ...
    const [formData, setFormData] = useState({
        // STEP 1: Informasi Detail Klien (CPP/CPW)
    ...
    const selectedCategory = useMemo(() => {
        return (
            categories.find((c) => c.id === formData.category_id || c.slug === formData.category_id) || {
                id: 'wedding',
    ...
    const selectedPackage = useMemo(() => {
        return packages.find((p) => p.id === formData.package_id);
    ...
    const steps = [
        { number: 1, title: 'Informasi Detail Klien (CPP/CPW)' },
        { number: 2, title: 'Informasi Alamat & Kontak' },
        { number: 3, title: 'Informasi Acara/Project & Informasi Tambahan' },
        { number: 4, title: 'Ringkasan' },
    ];

    return (
        <div className="min-h-screen bg-[#090C15] text-slate-100 font-sans antialiased py-6 px-3 sm:px-6 lg:px-8 flex flex-col justify-center">
            <Head title="Form Data Diri Client | Arams Pictures" />
            <Toaster position="top-right" richColors />

            <div className="max-w-full w-full mx-auto grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
                {/* ========================================================================= */}
                {/* LEFT SIDEBAR (Dark Brand Showcase) */}
                {/* ========================================================================= */}
                <div className="lg:col-span-3 xl:col-span-3 flex flex-col justify-between p-4 sm:p-6 rounded-3xl bg-[#0F1424] border border-white/5 space-y-6">
                    <div>
                        {/* Logo & Brand */}
                        ...
                        <div className="mt-8 space-y-2">
                            <h1 className="text-lg sm:text-xl font-bold text-white tracking-tight">
                                Form Data Diri Client
                            </h1>
                            <p className="text-xs text-slate-400 leading-relaxed">
                                Silakan lengkapi data diri Anda dengan benar. Data ini akan digunakan untuk keperluan pemesanan dan administrasi.
                            </p>
                        </div>

                        {/* Showcase Wedding Couple Photo */}
                        <div className="relative rounded-2xl overflow-hidden shadow-xl border border-white/10 aspect-[3/3.8] mt-6 group">
                            <img
                        ...
                        <div className="mt-6 p-4 rounded-2xl bg-white/5 border border-white/10 space-y-3">
                            ...
                            <a
                                href={`https://wa.me/${company.phone.replace(/[^0-9]/g, '')}?text=Halo%20Arams%20Pictures,%20saya%20butuh%20bantuan%20mengisi%20form%20klien`}
                                target="_blank"
                                rel="noreferrer"
                                className="w-full py-2 px-3 rounded-xl border border-white/20 text-white hover:bg-white/10 text-xs font-semibold flex items-center justify-center gap-1.5 transition-all"
                            >
                ...
                {/* ========================================================================= */}
                <div className="lg:col-span-9 xl:col-span-9 bg-white rounded-3xl p-6 sm:p-10 shadow-2xl border border-slate-100 min-h-[750px] flex flex-col justify-between text-slate-800">
                    <div>
                        {/* ================================================================= */}
                                            ...
                                            <div className="relative flex items-center justify-center mb-2">
                                                ...
                                                <button
                                                    ...
                                                    className={`w-9 h-9 rounded-full flex items-center justify-center text-xs font-bold transition-all ${
                                                        isDone
                                                            ? 'bg-indigo-600 text-white cursor-pointer hover:bg-indigo-700 shadow-md shadow-indigo-200'
                                                            : isCurrent
                            ...
                            <div className="space-y-6 animate-in fade-in duration-200">
                                <div>
                                    <h2 className="text-xl font-bold text-slate-900">
                                        Informasi Detail Klien (CPP/CPW)
                                    </h2>
                                    <p className="text-xs text-slate-500 mt-1">
                                        Lengkapi informasi calon pengantin pria (CPP) dan wanita (CPW).
                                    </p>
                                </div>
                                ...
                                <div className="bg-indigo-50/70 border border-indigo-100/90 rounded-2xl p-4 flex items-center gap-3 text-xs text-indigo-900">
                                    ...
                                    <span>
                                        <strong>Informasi penting:</strong> Pastikan semua data yang Anda input sesuai dengan KTP untuk keperluan administrasi.
                                    </span>
                                </div>
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                placeholder="Masukkan nama panggilan CPP"
                                                className="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 text-xs text-slate-900 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-600 transition-all"
                                            />
                                        </div>
                                        <div>
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                placeholder="Masukkan nama panggilan CPW"
                                                className="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 text-xs text-slate-900 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-600 transition-all"
                                            />
                                        </div>
                                        <div>
                        ...
                        {currentStep === 4 && (
                            <div className="space-y-6 animate-in fade-in duration-200">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    {/* Card 1: Informasi Calon Pengantin (CPW & CPP) */}
                        ...
                        <div className="flex items-center gap-3 w-full sm:w-auto justify-end">
                            {currentStep === 4 ? (
                                <>
                                    ...
                                    <div className="flex flex-col items-end">
                                        <button
                                            ...
                                            className="px-6 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-bold flex items-center gap-2 transition-all cursor-pointer shadow-md shadow-indigo-200 disabled:opacity-50"
                                        >
                                            {isSubmitting ? (
                                                <>
                                ...
                                <button
                                    type="button"
                                    onClick={handleNext}
                                    className="px-6 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-bold flex items-center gap-2 transition-all cursor-pointer shadow-md shadow-indigo-200"
                                >
                    ...
                    <div className="bg-white rounded-3xl p-8 max-w-md w-full text-center space-y-5 shadow-2xl border border-slate-100 animate-in zoom-in-95 duration-200">
                        ...
                        <div className="pt-2">
                            <button
                                ...
                                className="w-full py-3 px-6 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-bold transition-all shadow-md shadow-indigo-200 cursor-pointer"
                            >
                                Tutup
                            </button>
                        </div>
