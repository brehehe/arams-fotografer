...
export default function Dashboard({
    ...
    return (
        <div className="space-y-6 pb-12 w-full max-w-full">
            <Head title="Dashboard - Lensaria Photography" />
                            ...
                            {[
                                ...
                                <button
                                    ...
                                    className={`w-full text-left px-3 py-2 rounded-lg text-xs font-medium transition-colors cursor-pointer flex items-center justify-between ${
                                        activePeriod === p.id ? 'bg-[#C89445]/10 text-[#C89445] font-semibold' : 'text-slate-700 hover:bg-slate-50'
                                    }`}
                                >
                                    <span>{p.label}</span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 items-stretch">
                ...
                <div className="lg:col-span-5 bg-white p-5 rounded-2xl border border-slate-200/80 shadow-sm flex flex-col justify-between h-full">
                    ...
                    <div className="mt-4 pt-3 border-t border-slate-100 flex items-center justify-between text-xs text-slate-500">
                        <span>Pintasan cepat sistem Lensaria</span>
                                    ...
                                    <TableRow key={proj.id} className="hover:bg-slate-50/70 transition-colors">
                                        ...
                                        <TableCell className="px-6">
                                            ...
                                            <span className={`text-[10px] font-bold ${
                                                proj.deadline_status === 'completed' ? 'text-emerald-600'
                            ...
                            <div key={proj.id} className="p-4 bg-white space-y-2.5">
                                ...
                                <div className="space-y-1 pt-1">
                                    ...
                                    <div className="w-full bg-slate-100 rounded-full h-1.5 overflow-hidden">
                                        <div
                                            className={`h-full rounded-full transition-all duration-500 ${
                                                proj.progress === 100 ? 'bg-emerald-500' : 'bg-primary-accent'
                                            }`}
                                            style={{ width: `${proj.progress}%` }}
                                        />
                                    </div>
                            ...
                            {upcoming_deadlines && upcoming_deadlines.length > 0 ? (
                                upcoming_deadlines.slice(0, 5).map((dl) => (
                                    ...
                                    >
                                        ...
                                        <span className={`text-[11px] font-bold px-2.5 py-1 rounded-full border whitespace-nowrap shrink-0 ${
                                            dl.urgency === 'completed' ? 'text-emerald-700 bg-emerald-50 border-emerald-200'
                                        ...
                                        <div className="absolute right-0 mt-2 w-44 bg-white rounded-xl shadow-xl border border-slate-100 p-1.5 z-40 animate-in fade-in zoom-in-95">
                                            {[
                                                ...
                                                <button
                                                    ...
                                                    className={`w-full text-left px-3 py-1.5 rounded-lg text-xs font-medium transition-colors cursor-pointer flex items-center justify-between ${
                                                        activePerformancePeriod === opt.id
