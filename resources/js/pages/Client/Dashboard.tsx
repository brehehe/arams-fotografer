    ...
    return (
        <ClientLayout>
            ...
            <div className="space-y-8">
                ...
                <section className="relative rounded-3xl overflow-hidden shadow-md bg-[#240B10] text-white min-h-[300px] sm:min-h-[340px] flex items-center border border-[#3D141C]">
                    <div className="absolute inset-0 z-0">
                        ...
                        />
                        <div className="absolute inset-0 bg-gradient-to-r from-[#240B10] via-[#240B10]/85 to-transparent" />
                    </div>

                    <div className="relative z-10 p-6 sm:p-10 lg:p-12 max-w-2xl space-y-3">
                        <span className="text-[10px] font-extrabold tracking-[0.25em] text-rose-300 uppercase block">
                            {activePromo.tag}
                        </span>
                        <h1 className="text-2xl sm:text-3xl lg:text-4xl font-serif font-black tracking-tight text-white leading-tight">
                            {activePromo.title}
                        </h1>
                        <p className="text-xs sm:text-sm text-rose-100/80 leading-relaxed max-w-lg">
                            {activePromo.description}
                        </p>
                        <div className="pt-2">
                            <button
                                type="button"
                                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-white text-[#240B10] text-xs font-bold shadow-md hover:bg-rose-50 transition-all cursor-pointer"
                            >
                ...
                <section className="space-y-4">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                        <div>
                            <h2 className="text-xl sm:text-2xl font-serif font-black text-slate-900 flex items-center gap-2">
                                ...
                                <Heart className="w-4 h-4 text-rose-600 fill-rose-600 inline" />
                            </h2>
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        <div className="bg-white p-4 sm:p-5 rounded-2xl border border-slate-200/80 shadow-2xs space-y-3 flex flex-col justify-between">
                            <div className="flex items-center gap-3">
                                <div className="w-10 h-10 rounded-xl bg-[#FAF3EB] text-[#8C4A15] flex items-center justify-center">
                            ...
                            <Link href="/client/projects" className="inline-flex items-center gap-1 text-[11px] font-bold text-[#4A151B] hover:underline pt-1">
                                <span>Lihat semua project</span>
                        ...
                        <div className="flex-1 space-y-4 w-full">
                            <div className="space-y-1">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="px-2.5 py-0.5 rounded-md text-[10px] font-bold bg-[#FAF3EB] text-[#8C4A15] border border-[#E8CDB5]">
                                        Dalam Proses
                                    </span>
                                </div>
                                            ...
                                            <div key={step.step} className="flex flex-col items-center relative z-10 flex-1">
                                                ...
                                                <span
                                                    className={`text-[10px] font-bold mt-1 text-center hidden sm:block ${
                                                        isActive ? 'text-[#380E13]' : isDone ? 'text-slate-700' : 'text-slate-400'
                                                    }`}
                                                >
                                                    {step.title}
                                                </span>
                            ...
                            <div className="bg-[#FAF7F5] border border-amber-900/10 rounded-2xl p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                                <div className="flex items-center gap-3 text-xs text-slate-700">
                                    <div className="w-8 h-8 rounded-full bg-rose-100 text-[#4A151B] flex items-center justify-center shrink-0">
                                ...
                                <Link
                                    ...
                                    className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-white border border-slate-200 text-xs font-bold text-[#4A151B] hover:bg-rose-50 transition-colors shrink-0 shadow-2xs"
                                >
                ...
                <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div className="bg-white rounded-3xl border border-slate-200/80 p-5 shadow-2xs space-y-4 flex flex-col justify-between">
                        <div className="space-y-3">
                            ...
                            <div className="space-y-1">
                                <div className="w-full h-2 rounded-full bg-slate-100 overflow-hidden">
                                    <div className="h-full bg-[#380E13] rounded-full" style={{ width: '50%' }} />
                                </div>
                        ...
                        <Link
                            href={`/client/projects/${active_project?.id || '01a0473f-8eed-730c-a81b-3973c3d66eb3'}`}
                            className="w-full py-2 rounded-xl border border-slate-200 bg-white hover:bg-slate-50 text-xs font-bold text-[#4A151B] text-center transition-colors block"
                        >
                ...
                <section className="space-y-4">
                    <div className="flex items-center justify-between">
                        ...
                        <Link href="/client/projects" className="text-xs font-bold text-[#4A151B] hover:underline flex items-center gap-1">
                            <span>Lihat Semua Project</span>
                            <ArrowRight className="w-3 h-3" />
                        </Link>
                    </div>
