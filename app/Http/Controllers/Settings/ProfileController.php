...
class ProfileController extends Controller
{
    ...
    public function update(ProfileUpdateRequest $request): RedirectResponse
    {
        ...
        try {
            ...
            \Illuminate\Support\Facades\Log::error("Failed to update profile for user {$user->id}: {$e->getMessage()}", ['exception' => $e]);
            throw $e;
        }
    }
    ...
    public function destroy(ProfileDeleteRequest $request): RedirectResponse
    {
        ...
        try {
            ...
            \Illuminate\Support\Facades\DB::rollBack();
            \Illuminate\Support\Facades\Log::error("Failed to delete user profile {$user->id}: {$e->getMessage()}", ['exception' => $e]);
            throw $e;
        }
    }
}
