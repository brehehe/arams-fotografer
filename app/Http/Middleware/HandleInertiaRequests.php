    ...
    public function share(Request $request): array
    {
        return [
            ...
            'appSettings' => [
                ...
                'login_bg_photo' => (\App\Models\Setting::get('login_bg_photo') && !str_starts_with(\App\Models\Setting::get('login_bg_photo'), 'data:image')) ? \App\Models\Setting::get('login_bg_photo') : '',
                'login_headline' => \App\Models\Setting::get('login_headline', 'Abadikan Setiap Momen Berharga Anda'),
                'login_description' => \App\Models\Setting::get('login_description', 'Terima kasih telah mempercayakan momen spesial Anda kepada ' . \App\Models\Setting::get('company_name', 'Arams Pictures') . '.'),
                'login_welcome_text' => \App\Models\Setting::get('login_welcome_text', 'Welcome Back!'),
                'login_pillar_1_title' => \App\Models\Setting::get('login_pillar_1_title', 'Kualitas Terbaik'),
                'login_pillar_1_desc' => \App\Models\Setting::get('login_pillar_1_desc', 'Peralatan profesional & editing berkualitas tinggi.'),
                'login_pillar_2_title' => \App\Models\Setting::get('login_pillar_2_title', '100% Aman'),
                'login_pillar_2_desc' => \App\Models\Setting::get('login_pillar_2_desc', 'Data & file Anda aman bersama kami.'),
                'login_pillar_3_title' => \App\Models\Setting::get('login_pillar_3_title', 'Layanan Personal'),
                'login_pillar_3_desc' => \App\Models\Setting::get('login_pillar_3_desc', 'Kami mendengar & mewujudkan visi Anda.'),
